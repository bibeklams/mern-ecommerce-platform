...
function Dashboard() {
  ...
  const { sellerDashboard, loading, error } = useSelector(
  ...
  return (
    <main className="space-y-6">
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        <RevenueCard
          title="Total Revenue"
          amount={sellerDashboard?.totalRevenue || 0}
          bgColor="bg-white"
        ...
        <RevenueCard
          ...
          amount={sellerDashboard?.dailyRevenue || 0}
        />
      </div>
      ...
      <WeeklyRevenueChart
        weeklyRevenue={sellerDashboard?.weeklyRevenue || []}
      />
